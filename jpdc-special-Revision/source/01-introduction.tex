...
\textcolor{blue}{
\textbf{R3Q4:} The main challenge on executing these applications on an AMC is to maintain load balance. 
...
\textcolor{blue}{
\textbf{R3Q4:} The main drawback of this approach is the overhead introduced by the thread migration, thus resulting in limited performance no matter the potential of the underlying system.
}
